				...
				<main>
					...
					>
						...
						>
							...
							<p>
								I am always seeking to broaden my skills across
								the full stack, to further my understanding of
								efficient software architectures and toolings,
								as well as to develop myself as a better leader.
							</p>
							<p>
								In my spare time, you can find me working out,
								getting lost in my current hobby, or just having
